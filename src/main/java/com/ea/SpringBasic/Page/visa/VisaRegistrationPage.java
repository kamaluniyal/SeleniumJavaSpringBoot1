package com.ea.SpringBasic.Page.visa;
...
public class VisaRegistrationPage extends Base {
    ...
    public void setComments(String comments){
        // since comments are not present for some users
        // those records scomes as null which throws exception
        //hence doing this to resolve it
